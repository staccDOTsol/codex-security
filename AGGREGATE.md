...
| 2026-09-05 | 11,422 | 115 | $1.16 | -151.9% | 1.82x |
...
| --- | --- |
| `grok-4.6` | 1,669 |
| `deepseek/deepseek-v4-flash` | 1,664 |
| `gpt-4o-mini` | 1,654 |
| `gemini-2.5-flash` | 1,625 |
| `google/gemini-2.5-flash` | 273 |
| `claude-sonnet-5` | 226 |
| `qwen/qwen-2.5-7b-instruct` | 92 |
