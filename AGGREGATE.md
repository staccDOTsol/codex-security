...
| 2026-08-18 | 59,630 | 4,332 | $746.75 | 37.9% | 2.7x |

## Top models

| model | calls |
| --- | --- |
| `google/gemini-2.5-flash` | 1,094 |
| `anthropic/claude-sonnet-4` | 1,087 |
| `openai/gpt-4o-mini` | 1,083 |
| `x-ai/grok-4.6` | 1,078 |
| `anthropic/claude-sonnet-5` | 38 |
| `anthropic/claude-opus-5` | 34 |
