...
| 2026-08-22 | 28,168 | 9 | $40.85 | 42.6% | 1.64x |

## Top models

| model | calls |
| --- | --- |
| `google/gemini-2.5-flash` | 2,058 |
| `anthropic/claude-sonnet-4` | 2,055 |
| `openai/gpt-4o-mini` | 2,052 |
| `x-ai/grok-4.6` | 2,046 |
| `upstage/solar-pro4` | 1,741 |
| `anthropic/claude-opus-4` | 26 |
| `anthropic/claude-sonnet-5` | 23 |
