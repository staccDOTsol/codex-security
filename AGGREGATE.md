...
| 2026-08-19 | 59,043 | 1,083 | $163.99 | 18.5% | 1.49x |

## Top models

| model | calls |
| --- | --- |
| `anthropic/claude-sonnet-4` | 689 |
| `google/gemini-2.5-flash` | 688 |
| `x-ai/grok-4.6` | 687 |
| `openai/gpt-4o-mini` | 686 |
| `anthropic/claude-sonnet-5` | 623 |
| `deepseek/deepseek-v4-pro-0813` | 101 |
