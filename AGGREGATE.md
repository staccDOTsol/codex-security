...
| 2026-08-23 | 3,167 | 4 | $0.0000 | -3613.8% | 37.11x |

## Top models

| model | calls |
| --- | --- |
| `google/gemini-2.5-flash` | 292 |
| `anthropic/claude-sonnet-4` | 291 |
| `openai/gpt-4o-mini` | 291 |
| `x-ai/grok-4.6` | 289 |
| `upstage/solar-pro4` | 274 |
| `nvidia/nemotron-3.5-lightning` | 8 |
