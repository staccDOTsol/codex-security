...
Source: `https://x402-tokens.fly.dev/v1/stats` · day `2026-09-17`
...
| 2026-09-17 | 3,220 | 0 | $0.0000 | — | — |

## Top models

| model | calls |
| --- | --- |
| `claude-sonnet-5` | 2,734 |
| `qwen/qwen-2.5-7b-instruct` | 144 |
| `gemini-3-6-flash` | 72 |
| `grok-4.6` | 72 |
| `deepseek-v4-pro` | 72 |
