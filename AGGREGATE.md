...
| 2026-08-18 | 53,459 | 4,332 | $746.75 | 37.9% | 2.7x |

## Top models

| model | calls |
| --- | --- |
| `google/gemini-2.5-flash` | 1,008 |
| `x-ai/grok-4.6` | 999 |
| `anthropic/claude-sonnet-4` | 997 |
| `openai/gpt-4o-mini` | 995 |
| `anthropic/claude-opus-5` | 110 |
| `anthropic/claude-opus-5-fast` | 88 |
| `anthropic/claude-sonnet-5` | 74 |
| `nvidia/nemotron-3.5-lightning` | 23 |
| `deepseek/deepseek-v4-pro-0813` | 17 |
