...
| 2026-08-18 | 58,488 | 4,332 | $746.75 | 37.9% | 2.7x |

## Top models

| model | calls |
| --- | --- |
| `google/gemini-2.5-flash` | 1,096 |
| `anthropic/claude-sonnet-4` | 1,089 |
| `openai/gpt-4o-mini` | 1,085 |
| `x-ai/grok-4.6` | 1,081 |
| `anthropic/claude-sonnet-5` | 74 |
| `anthropic/claude-opus-5` | 66 |
