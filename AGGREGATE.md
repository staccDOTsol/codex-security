...
| 2026-08-20 | 88,288 | 20,111 | $265.04 | 7.6% | 1.3x |
...
| --- | --- |
| `x-ai/grok-4.6` | 1,990 |
| `openai/gpt-4o-mini` | 1,080 |
| `google/gemini-2.5-flash` | 1,071 |
| `anthropic/claude-sonnet-4` | 1,066 |
| `anthropic/claude-opus-5` | 828 |
| `anthropic/claude-sonnet-5` | 760 |
| `writer/palmyra-x5` | 694 |
| `inclusionai/ling-2.6-flash` | 436 |
| `google/gemini-3.7-flash` | 311 |
