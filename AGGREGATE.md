...
| 2026-09-05 | 17,002 | 128 | $1.19 | -191.9% | 1.83x |

## Top models

| model | calls |
| --- | --- |
| `deepseek/deepseek-v4-flash` | 1,736 |
| `grok-4.6` | 1,735 |
| `gpt-4o-mini` | 1,722 |
| `gemini-2.5-flash` | 1,702 |
| `openai/gpt-4o-mini` | 646 |
| `google/gemini-2.5-flash` | 375 |
| `claude-sonnet-5` | 129 |
| `qwen/qwen-2.5-7b-instruct` | 109 |
| `gemini-3-6-flash` | 36 |
| `deepseek-v4-pro` | 36 |
