...
| 2026-08-18 | 64,249 | 4,332 | $746.75 | 37.9% | 2.7x |

## Top models

| model | calls |
| --- | --- |
| `google/gemini-2.5-flash` | 1,141 |
| `anthropic/claude-sonnet-4` | 1,138 |
| `openai/gpt-4o-mini` | 1,137 |
| `x-ai/grok-4.6` | 1,129 |
