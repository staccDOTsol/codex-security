...
| 2026-08-18 | 67,930 | 4,332 | $746.75 | 37.9% | 2.7x |

## Top models

| model | calls |
| --- | --- |
| `google/gemini-2.5-flash` | 1,208 |
| `anthropic/claude-sonnet-4` | 1,204 |
| `openai/gpt-4o-mini` | 1,202 |
| `x-ai/grok-4.6` | 1,195 |
