...
| 2026-09-06 | 23,640 | 160 | $6.43 | 32.9% | 2.71x |

## Top models

| model | calls |
| --- | --- |
| `gemini-2.5-flash` | 1,553 |
| `grok-4.6` | 1,519 |
| `gpt-4o-mini` | 1,516 |
| `deepseek/deepseek-v4-flash` | 1,512 |
| `claude-opus-5` | 462 |
| `google/gemini-2.5-flash` | 436 |
| `claude-sonnet-5` | 350 |
