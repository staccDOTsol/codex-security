...
| 2026-08-25 | 31,602 | 890 | $246.87 | 77.1% | 1.04x |

## Top models

| model | calls |
| --- | --- |
| `openai/gpt-4o-mini` | 1,671 |
| `upstage/solar-pro4` | 1,607 |
| `anthropic/claude-sonnet-4` | 1,599 |
| `google/gemini-2.5-flash` | 1,597 |
| `x-ai/grok-4.6` | 1,594 |
| `openai/gpt-5.6-sol` | 374 |
| `anthropic/claude-fable-5` | 250 |
